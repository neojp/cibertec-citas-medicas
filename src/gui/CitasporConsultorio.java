...
public class CitasporConsultorio extends JDialog {
	...
	public static void main(String[] args) {
		try {
			CitasporConsultorio dialog = new CitasporConsultorio();
	 ...
	 * Create the dialog.
	 */
	public CitasporConsultorio() {
		setTitle("Citas por Consultorio");
		...
		lblNombre.setBounds(20, 45, 68, 14);
